...
public class IO {
   ...
   static String[] getStringArray(String message, int size){
    ...
    public static void print(ArrayList<Card> arr){ //print Card arrayList (for blackjack)
        for (Card card : arr) {
...
//        System.out.println();
    ...
    public static void print(ArrayList<Card> arr, int sizeToPrint){ //print Card arrayList (for blackjack)
        int count = 0;
        for (Card card : arr) {
            while (count < sizeToPrint){
                System.out.println(card.getDetails());
                count++;
            }
        }
